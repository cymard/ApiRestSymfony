...
//             $this->request->query->getInt('page', $page), // Numéro de la page en cours, passé dans l'URL, 1 si aucune page
...
//      */
//     public function getCategoryProducts (ProductRepository $productRepository, NormalizerInterface $normalizerInterface)
//     {
//         if($this->request->query->get('search') && $this->request->query->get('category') && $this->request->query->get('page') && $this->request->query->get('sorting')){

//             // récuperer la valeur de la recherche
//             $search =  $this->request->query->get('search');
//             $page = (int)$this->request->query->get('page');
//             $sort = $this->request->query->get('sorting');
//             $category =  $this->getCategory($this->request->query->get('category'));
...
//         }else if($this->request->query->get('category') && $this->request->query->get('page') && $this->request->query->get('sorting') ){
//             $sort = $this->request->query->get('sorting');
//             $category =  $this->getCategory($this->request->query->get('category'));
//             $page = (int)$this->request->query->get('page');
...
//      * Delete products
//      */
//     public function deleteProduct( ProductRepository $repo, EntityManagerInterface $entityManager){
...
//         return $this->sendJsonResponse(['status' => 202,'message' => 'All products deleted']);
//     }
