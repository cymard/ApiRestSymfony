 ...
 */
final class Version20210223154328 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP report, CHANGE product_id product_id INT NOT NULL, CHANGE date date DATETIME DEFAULT \'CURRENT_TIME\'');
    }
}
